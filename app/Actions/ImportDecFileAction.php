        ...
        return DB::transaction(function () use ($parsed, $uploadedFile, $sha, $header) {
            ...
            $declaration = Declaration::updateOrCreate(
                ...
                [
                    ...
                    'total_rend_exclusiva' => $parsed->totalRendExclusiva,
                    'total_rend_recebidos_acumuladamente' => $parsed->totalRendRecebidosAcumuladamente,
                    'rend_trib_pj' => $parsed->rendTribPj,
                    'rend_trib_pf_exterior' => $parsed->rendTribPfExterior,
                    ...
                    'total_imposto_pago_retido' => $parsed->totalImpostoPagoRetido,
                    'total_pagamentos_efetuados' => $parsed->totalPagamentosEfetuados,
                    'total_doacoes_efetuadas' => $parsed->totalDoacoesEfetuadas,
                    'total_doacoes_partidos_politicos' => $parsed->totalDoacoesPartidosPoliticos,
                    'total_atividade_rural_resultado_tributavel' => $parsed->totalAtividadeRuralResultadoTributavel,
                    'total_renda_variavel' => $parsed->totalRendaVariavel,
                    ...
                    'total_bens_ano_anterior' => $parsed->totalBensAnoAnterior,
                    'total_bens_ano_atual' => $parsed->totalBensAnoAtual,
                    'total_bens_reais' => $parsed->totalBensReais,
                    'total_dividas_ano_anterior' => $parsed->totalDividasAnoAnterior,
                    'total_dividas_ano_atual' => $parsed->totalDividasAnoAtual,
                    'total_dividas_onus_reais' => $parsed->totalDividasOnusReais,
